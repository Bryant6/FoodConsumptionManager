                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom">
                        <form role="form" action="/user/register" method="post" class="login-form">
                            ...
                            <div class="form-group">
                                <label class="sr-only" for="form-password">Password</label>
                                <input type="password" name="repassword" placeholder="再次确认密码..." class="form-password form-control" id="form-repassword">
                            </div>
                            <button type="submit" class="btn">注 册</button><hr/>
                            <a href="login.jsp"><button type="button" class="btn">返 回 登 录</button></a>
                        </form>
                    </div>
                </div>
            </div>
