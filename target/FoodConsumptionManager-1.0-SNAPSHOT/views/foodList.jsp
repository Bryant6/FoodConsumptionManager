    ...
    <table align="center" width="1400" border="1" style="line-height: 40px; font-family: '华文楷体';">
        ...
        <c:forEach items="${foodList}" var="food">
            <tr>
                ...
                <td>${food.canteen}</td>
                <td>
                    <a href="<c:url value='/food/selectFoodById?id=${food.id}'/> ">修改</a>
                    <a href="<c:url value='/food/deleteFood?id=${food.id}'/> ">删除</a>
                </td>
            </tr>
...
<h2 style="font-family: '华文宋体'; text-align: center; color: #112CEB;"><a href="${pageContext.request.contextPath}/views/addFood.jsp">添加新菜单</a></h2>
